import { r as reactExports, j as jsxRuntimeExports, e } from "./react.mjs";
...
function ClientOnly({ children, fallback = null }) {
  return useHydrated() ? /* @__PURE__ */ jsxRuntimeExports.jsx(e.Fragment, { children }) : /* @__PURE__ */ jsxRuntimeExports.jsx(e.Fragment, { children: fallback });
}
function useHydrated() {
  return e.useSyncExternalStore(subscribe, () => true, () => false);
}
function subscribe() {
  return () => {
  };
...
var Route = class extends BaseRoute {
  ...
  */
  constructor(options) {
    ...
    this.Link = e.forwardRef((props, ref) => {
