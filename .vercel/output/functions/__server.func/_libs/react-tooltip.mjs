...
function w({ css: e2, id: t = "react-tooltip-base-styles", type: o = "base", ref: r, state: n = {} }) {
  if (!e2 || "undefined" == typeof document || (void 0 !== n[o] ? n[o] : y[o])) return;
  ...
  i.id = t, i.type = "text/css", "top" === l && c.firstChild ? c.insertBefore(i, c.firstChild) : c.appendChild(i), i.styleSheet ? i.styleSheet.cssText = e2 : i.appendChild(document.createTextNode(e2)), void 0 !== n[o] ? n[o] = true : y[o] = true;
}
const b = flip({ fallbackAxisSideDirection: "start" }), S = shift({ padding: 5 }), g = async ({ elementReference: e2 = null, tooltipReference: t = null, tooltipArrowReference: o = null, place: r = "top", offset: n = 10, strategy: l = "absolute", middlewares: c = [offset(Number(n)), b, S], border: i, arrowSize: s = 8 }) => {
  if (!e2) return { tooltipStyles: {}, tooltipArrowStyles: {}, place: r };
  if (null === t) return { tooltipStyles: {}, tooltipArrowStyles: {}, place: r };
  const u = [...c];
  return o ? (u.push(arrow({ element: o, padding: 5 })), computePosition(e2, t, { placement: r, strategy: l, middleware: u }).then(({ x: e3, y: t2, placement: o2, middlewareData: r2 }) => {
    var n2, l2;
    const c2 = { left: `${e3}px`, top: `${t2}px`, border: i }, { x: u2, y: a } = null !== (n2 = r2.arrow) && void 0 !== n2 ? n2 : { x: 0, y: 0 }, d = null !== (l2 = { top: "bottom", right: "left", bottom: "top", left: "right" }[o2.split("-")[0]]) && void 0 !== l2 ? l2 : "bottom", p = i && { borderBottom: i, borderRight: i };
    let v = 0;
    if (i) {
      const e4 = `${i}`.match(/(\d+)px/);
  ...
  })) : computePosition(e2, t, { placement: "bottom", strategy: l, middleware: u }).then(({ x: e3, y: t2, placement: o2 }) => ({ tooltipStyles: { left: `${e3}px`, top: `${t2}px` }, tooltipArrowStyles: {}, place: o2 }));
}, A = (e2, t, o) => {
  let r = null, n = e2;
  const l = function(...e3) {
    const o2 = () => {
    ...
    r || (n.apply(this, e3), r = setTimeout(o2, t));
  };
  return l.cancel = () => {
  ...
  const t = getComputedStyle(e2);
  return ["overflow", "overflow-x", "overflow-y"].some((e3) => {
    const o = t.getPropertyValue(e3);
    return "auto" === o || "scroll" === o;
  });
}, _ = (e2) => {
  if (!e2) return null;
  let t = e2.parentElement;
  for (; t; ) {
    if (E(t)) return t;
    t = t.parentElement;
  }
...
let N = null;
function x(e2) {
  const t = e2.match(/^\[data-tooltip-id=(['"])((?:\\.|(?!\1).)*)\1\]$/);
...
function B(e2, t) {
  var o, r, n, l;
  const c = L(e2), i = null !== (r = null === (o = c.error) || void 0 === o ? void 0 : o.message) && void 0 !== r ? r : null, s = null !== (l = null === (n = t.error) || void 0 === n ? void 0 : n.message) && void 0 !== l ? l : null;
  if (u = t.anchors, a = c.anchors, u.length === a.length && u.every((e3, t2) => e3 === a[t2]) && i === s) return;
  var u, a;
  const d = { ...t, anchors: c.anchors, error: c.error };
  R.set(e2, d), (function(e3) {
    e3.subscribers.forEach((t2) => t2(e3.anchors, e3.error));
  })(d);
}
let z = false, $ = null, I = false;
function j(e2) {
  if (e2 ? ($ || ($ = /* @__PURE__ */ new Set()), e2.forEach((e3) => $.add(e3))) : I = true, z) return;
  z = true;
  const t = () => {
    z = false;
    const e3 = I, t2 = $;
    var o;
    I = false, $ = null, e3 ? R.forEach((e4, t3) => {
      B(t3, e4);
    }) : t2 && t2.size > 0 && (o = t2, R.forEach((e4, t3) => {
      (null === e4.tooltipId || o.has(e4.tooltipId)) && B(t3, e4);
    }));
  };
  "function" == typeof requestAnimationFrame ? requestAnimationFrame(t) : Promise.resolve().then(t);
}
function D() {
  N || "undefined" == typeof MutationObserver || (N = new MutationObserver((e2) => {
    const t = (function(e3) {
      var t2;
      ...
      for (const r of e3) {
        if ("attributes" === r.type) {
          const e4 = r.target, n = null === (t2 = e4.getAttribute) || void 0 === t2 ? void 0 : t2.call(e4, "data-tooltip-id");
        ...
        if ("childList" === r.type) {
          const e4 = (e5) => {
            ...
            for (let n = 0; n < e5.length; n++) {
              ...
              if (s) {
                ...
                for (let e6 = 0; e6 < s.length; e6++) {
                  const t4 = s[e6].getAttribute("data-tooltip-id");
                  t4 && o.add(t4);
                }
              }
            }
          ...
          if (e4(r.addedNodes) || e4(r.removedNodes)) return null;
          continue;
        }
      }
      return o;
...
function H(e2, t) {
  ...
  if (!o) {
    const t2 = L(e2);
    o = { anchors: t2.anchors, error: t2.error, subscribers: /* @__PURE__ */ new Set(), tooltipId: x(e2) }, R.set(e2, o);
  }
  return o.subscribers.add(t), D(), t([...o.anchors], o.error), () => {
    const o2 = R.get(e2);
    o2 && (o2.subscribers.delete(t), 0 === o2.subscribers.size && R.delete(e2), 0 === R.size && N && (N.disconnect(), N = null));
  };
}
const M = /* @__PURE__ */ new Map();
function P(e2, t) {
  return `${e2}:${t ? "capture" : "bubble"}`;
}
function W(e2, t, o = {}) {
  const r = Boolean(o.capture), n = P(e2, r), l = (function(e3, t2) {
    const o2 = P(e3, t2);
    let r2 = M.get(o2);
    if (!r2) {
      const n2 = /* @__PURE__ */ new Set(), l2 = (e4) => {
        n2.forEach((t3) => {
          t3(e4);
        });
      };
      r2 = { handlers: n2, dispatch: l2, eventType: e3, capture: t2 }, M.set(o2, r2), document.addEventListener(e3, l2, { capture: t2 });
    }
    return r2;
  })(e2, r);
  return l.handlers.add(t), () => {
    l.handlers.delete(t), 0 === l.handlers.size && (M.delete(n), document.removeEventListener(e2, l.dispatch, { capture: r }));
  };
}
let q = null;
var F = reactExports.memo(({ forwardRef: t, id: c, className: d, classNameArrow: p, variant: v = "dark", portalRoot: m, anchorSelect: f, place: y2 = "top", offset: w2 = 10, openOnClick: b2 = false, positionStrategy: S2 = "absolute", middlewares: E2, wrapper: R2, delayShow: N2 = 0, delayHide: x2 = 0, autoClose: L2, float: B2 = false, hidden: z2 = false, noArrow: $2 = false, clickable: I2 = false, openEvents: j2, closeEvents: D2, globalCloseEvents: M2, imperativeModeOnly: P2, style: F2, position: V2, afterShow: K2, afterHide: Y2, disableTooltip: X2, content: G2, contentWrapperRef: Z2, isOpen: J, defaultIsOpen: Q = false, setIsOpen: U, previousActiveAnchor: ee, activeAnchor: te, setActiveAnchor: oe, border: re, opacity: ne, arrowColor: le, arrowSize: ce = 8, role: ie = "tooltip" }) => {
  ...
  reactExports.useEffect(() => {
    if (c) {
      if (ye) {
        t2(ee);
        const o = e2(te), r = [.../* @__PURE__ */ new Set([...o, c])].filter(Boolean).join(" ");
    ...
    function e2(e3) {
      var t3;
      return (null === (t3 = null == e3 ? void 0 : e3.getAttribute("aria-describedby")) || void 0 === t3 ? void 0 : t3.split(" ")) || [];
    }
    function t2(t3) {
      const o = e2(t3).filter((e3) => e3 !== c);
  ...
  const Re = reactExports.useCallback((e2) => {
    ke.current && he((t2) => t2.place === e2.place && t2.tooltipStyles.left === e2.tooltipStyles.left && t2.tooltipStyles.top === e2.tooltipStyles.top && t2.tooltipStyles.border === e2.tooltipStyles.border && t2.tooltipArrowStyles.left === e2.tooltipArrowStyles.left && t2.tooltipArrowStyles.top === e2.tooltipArrowStyles.top && t2.tooltipArrowStyles.right === e2.tooltipArrowStyles.right && t2.tooltipArrowStyles.bottom === e2.tooltipArrowStyles.bottom && t2.tooltipArrowStyles.borderBottom === e2.tooltipArrowStyles.borderBottom && t2.tooltipArrowStyles.borderRight === e2.tooltipArrowStyles.borderRight ? t2 : e2);
  }, []), Ne = reactExports.useRef(be);
  Ne.current = be;
  const xe = reactExports.useCallback((e2 = N2) => {
    de.current && clearTimeout(de.current), Ne.current ? Ce(true) : de.current = setTimeout(() => {
      Ce(true);
    }, e2);
  }, [N2, Ce]), Le = reactExports.useCallback((e2 = x2) => {
    pe.current && clearTimeout(pe.current), pe.current = setTimeout(() => {
      Te.current || Ce(false);
    }, e2);
  }, [x2, Ce]), Be = reactExports.useCallback(({ x: e2, y: t2 }) => {
    var o;
    Oe.current.getBoundingClientRect = () => ({ x: e2, y: t2, width: 0, height: 0, top: t2, left: e2, right: e2, bottom: t2 }), g({ place: null !== (o = null == ge ? void 0 : ge.place) && void 0 !== o ? o : y2, offset: w2, elementReference: Oe.current, tooltipReference: ue.current, tooltipArrowReference: ae.current, strategy: S2, middlewares: E2, border: re, arrowSize: ce }).then((e3) => {
      Re(e3);
    });
  }, [null == ge ? void 0 : ge.place, y2, w2, S2, E2, re, ce, Re]), ze = reactExports.useCallback(() => {
    var e2, t2;
    const o = null !== (e2 = null == ge ? void 0 : ge.position) && void 0 !== e2 ? e2 : V2;
    o ? Be(o) : B2 ? _e.current && Be(_e.current) : (null == te ? void 0 : te.isConnected) && g({ place: null !== (t2 = null == ge ? void 0 : ge.place) && void 0 !== t2 ? t2 : y2, offset: w2, elementReference: te, tooltipReference: ue.current, tooltipArrowReference: ae.current, strategy: S2, middlewares: E2, border: re, arrowSize: ce }).then((e3) => {
      ke.current && Re(e3);
    });
  ...
  }, [Ce, oe]), Ie = be || Q || Boolean(J) || Boolean(te) || Boolean(null == ge ? void 0 : ge.anchorSelect), { anchorElements: je, selector: De } = (({ id: e2, anchorSelect: t2, imperativeAnchorSelect: c2, activeAnchor: i, disableTooltip: s, onActiveAnchorRemoved: u, trackAnchors: a }) => {
    const [d2, p2] = reactExports.useState([]), [v2, m2] = reactExports.useState(null), f2 = reactExports.useRef(null), h = reactExports.useMemo(() => (({ id: e3, anchorSelect: t3, imperativeAnchorSelect: o }) => {
      var r;
      let n = null !== (r = null != o ? o : t3) && void 0 !== r ? r : "";
      return !n && e3 && (n = `[data-tooltip-id='${e3.replace(/'/g, "\\'")}']`), n;
    })({ id: e2, anchorSelect: t2, imperativeAnchorSelect: c2 }), [e2, t2, c2]), y3 = reactExports.useMemo(() => d2.filter((e3) => !(null == s ? void 0 : s(e3))), [d2, s]), w3 = reactExports.useMemo(() => {
      if (!i || !h) return false;
      try {
        return i.matches(h);
      } catch (e3) {
    ...
    return reactExports.useEffect(() => h && a ? H(h, (e3, t3) => {
      p2(e3), m2(t3);
  ...
  (({ activeAnchor: e2, anchorElements: t2, anchorSelector: r, clickable: c2, closeEvents: i, delayHide: s, delayShow: u, disableTooltip: a, float: d2, globalCloseEvents: p2, handleHideTooltipDelayed: v2, handleShow: m2, handleShowTooltipDelayed: f2, handleTooltipPosition: y3, hoveringTooltip: w3, imperativeModeOnly: b3, lastFloatPosition: S3, openEvents: g2, openOnClick: E3, rendered: T2, setActiveAnchor: O2, show: C2, tooltipHideDelayTimerRef: R3, tooltipRef: N3, tooltipShowDelayTimerRef: x3, updateTooltipPosition: L3 }) => {
    ...
    e2 !== j3.current && (j3.current = e2, $3.current = _(e2));
    const H2 = N3.current;
    ...
    const M3 = E3 || (null == g2 ? void 0 : g2.click) || (null == g2 ? void 0 : g2.dblclick) || (null == g2 ? void 0 : g2.mousedown), P3 = reactExports.useMemo(() => {
      ...
      const e3 = i ? { ...i } : { mouseleave: true, blur: true, click: false, dblclick: false, mouseup: false };
      return !i && E3 && Object.assign(e3, { mouseleave: false, blur: false }), b3 && Object.assign(e3, { mouseleave: false, blur: false, click: false, dblclick: false, mouseup: false }), e3;
    }, [i, E3, b3]), F3 = reactExports.useMemo(() => {
      const e3 = p2 ? { ...p2 } : { escape: false, scroll: false, resize: false, clickOutsideAnchor: M3 || false };
      return b3 && Object.assign(e3, { escape: false, scroll: false, resize: false, clickOutsideAnchor: false }), e3;
    }, [p2, M3, b3]), V3 = reactExports.useRef(e2);
    V3.current = e2;
    ...
    const J2 = reactExports.useRef(() => null), Q2 = reactExports.useRef(() => {
      ...
      const t3 = e3.match(/^\[data-tooltip-id=(['"])((?:\\.|(?!\1).)*)\1\]$/);
      return t3 ? t3[2].replace(/\\(['"])/g, "$1") : null;
    })(r) : null;
    J2.current = (e3) => {
      var t3, o;
      if (!(e3 instanceof Element && e3.isConnected)) return null;
      const n = e3;
      if (ee2) {
        const e4 = (function(e5, t4) {
          ...
          for (; o2; ) {
            const e6 = o2.dataset;
            if ((null == e6 ? void 0 : e6.tooltipId) === t4) return o2;
            o2 = o2.parentElement;
          }
          return null;
        })(n, ee2);
        if (e4 && !(null == a ? void 0 : a(e4))) return e4;
      } else if (r) try {
        const e4 = null !== (t3 = n.matches(r) ? n : n.closest(r)) && void 0 !== t3 ? t3 : null;
        if (e4 && !(null == a ? void 0 : a(e4))) return e4;
      } catch (e4) {
        return null;
      }
      return null !== (o = Y3.current.find((e4) => e4 === n || e4.contains(n))) && void 0 !== o ? o : null;
    }, Q2.current = (e3) => {
      e3 && (e3.isConnected ? (null == a ? void 0 : a(e3)) || (u && V3.current && e3 !== V3.current ? (x3.current && clearTimeout(x3.current), x3.current = setTimeout(() => {
        O2(e3), m2(true);
      }, u)) : (O2(e3), u ? f2() : m2(true)), R3.current && clearTimeout(R3.current)) : O2(null));
    }, U2.current = () => {
    ...
    te2.setCallback((e3) => Q2.current(e3)), oe2.setCallback(() => U2.current()), reactExports.useEffect(() => {
      const e3 = [], t3 = (t4, o2, r3) => {
        e3.push(W(t4, o2, r3));
      }, o = (e4) => {
        var t4;
        return Boolean((null == e4 ? void 0 : e4.target) instanceof Node && (null === (t4 = V3.current) || void 0 === t4 ? void 0 : t4.contains(e4.target)));
      }, r2 = (e4) => {
        oe2.cancel(), te2(e4);
      }, n = () => {
        te2.cancel(), oe2();
        ...
        t3("mouseover", (e4) => {
          const t4 = J2.current(e4.target);
          t4 && J2.current(e4.relatedTarget) !== t4 && r2(t4);
        });
      }, i2 = () => {
        t3("mouseout", (e4) => {
          const t4 = J2.current(e4.target);
          if (!t4 && !o(e4)) return;
          const r3 = e4.relatedTarget, l2 = t4 || V3.current;
          r3 instanceof Node && (null == l2 ? void 0 : l2.contains(r3)) || n();
        });
      };
      P3.mouseenter && l(), q2.mouseleave && i2(), P3.mouseover && l(), q2.mouseout && i2(), P3.focus && t3("focusin", (e4) => {
        r2(J2.current(e4.target));
      }), q2.blur && t3("focusout", (e4) => {
        const t4 = J2.current(e4.target);
        if (!t4 && !o(e4)) return;
        const r3 = e4.relatedTarget, l2 = t4 || V3.current;
        r3 instanceof Node && (null == l2 ? void 0 : l2.contains(r3)) || n();
      });
      const s2 = ["mouseover", "mouseout", "mouseenter", "mouseleave", "focus", "blur"], u2 = ["click", "dblclick", "mousedown", "mouseup"], a2 = (e4) => {
        var t4;
        const o2 = J2.current(null !== (t4 = null == e4 ? void 0 : e4.target) && void 0 !== t4 ? t4 : null);
        o2 && (K3.current && V3.current === o2 || Q2.current(o2));
      }, p3 = (e4) => {
        K3.current && o(e4) && U2.current();
      };
      Object.entries(P3).forEach(([e4, o2]) => {
        o2 && !s2.includes(e4) && u2.includes(e4) && t3(e4, a2, { capture: true });
      }), Object.entries(q2).forEach(([e4, o2]) => {
        o2 && !s2.includes(e4) && u2.includes(e4) && t3(e4, p3, { capture: true });
      }), d2 && t3("pointermove", (e4) => {
        const t4 = V3.current;
        if (!t4) return;
        if (J2.current(e4.target) !== t4) return;
        const o2 = e4, r3 = { x: o2.clientX, y: o2.clientY };
      ...
      return h && (null == v3 || v3.addEventListener("mouseover", m3), null == v3 || v3.addEventListener("mouseout", f3)), () => {
        e3.forEach((e4) => e4()), h && (null == v3 || v3.removeEventListener("mouseover", m3), null == v3 || v3.removeEventListener("mouseout", f3)), te2.cancel(), oe2.cancel();
      };
      ...
      let n = null;
      F3.resize ? window.addEventListener("resize", t3) : e2 && N3.current && (n = autoUpdate(e2, N3.current, () => Z3.current(), { ancestorResize: true, elementResize: true, layoutShift: true }));
      const l = (e3) => {
      ...
      const c3 = (e3) => {
        ...
        const r3 = e3.target;
        r3 instanceof Node && r3.isConnected && ((null === (t4 = N3.current) || void 0 === t4 ? void 0 : t4.contains(r3)) || (null === (o2 = V3.current) || void 0 === o2 ? void 0 : o2.contains(r3)) || Y3.current.some((e4) => null == e4 ? void 0 : e4.contains(r3)) || (X3.current(false), k(x3)));
      };
  ...
  He.current = ze, reactExports.useEffect(() => {
    ...
    return t2.observe(Z2.current), () => {
      t2.disconnect(), e2 && clearTimeout(e2);
    };
  ...
  reactExports.useImperativeHandle(t, () => ({ open: (e2) => {
    let t2 = null;
    if (null == e2 ? void 0 : e2.anchorSelect) {
      try {
        t2 = document.querySelector(e2.anchorSelect);
      } catch (e3) {
        return;
      }
      if (!t2) return;
    }
    t2 && oe(t2), Ae(null != e2 ? e2 : null), (null == e2 ? void 0 : e2.delay) ? xe(e2.delay) : Ce(true);
  }, close: (e2) => {
    (null == e2 ? void 0 : e2.delay) ? Le(e2.delay) : Ce(false);
  }, activeAnchor: te, place: fe.place, isOpen: Boolean(be && !z2 && Pe && We) })), reactExports.useEffect(() => () => {
    k(de), k(pe), k(ve), k(me);
  }, []);
  const Ke = be && !z2 && Pe ? e.createElement(R2, { id: c, role: ie, className: clsx("react-tooltip", O.tooltip, C.tooltip, C[v], d, `react-tooltip__place-${fe.place}`, O[We ? "show" : "closing"], We ? "react-tooltip__show" : "react-tooltip__closing", "fixed" === S2 && O.fixed, I2 && O.clickable), onTransitionEnd: (e2) => {
    k(me), ye || "opacity" !== e2.propertyName || (Se(false), Ae(null), null == Y2 || Y2());
  }, style: qe, ref: ue }, e.createElement(R2, { className: clsx("react-tooltip-content-wrapper", O.content, C.content) }, Me), e.createElement(R2, { className: clsx("react-tooltip-arrow", O.arrow, C.arrow, p, $2 && O.noArrow), style: Ve, ref: ae })) : null;
...
function X(e2, t) {
  const o = (K || (K = new MutationObserver((e3) => {
    var t2;
    for (const o2 of e3) {
      if ("attributes" !== o2.type || !(null === (t2 = o2.attributeName) || void 0 === t2 ? void 0 : t2.startsWith("data-tooltip-"))) continue;
      const e4 = o2.target, r2 = V.get(e4);
      r2 && r2.forEach((t3) => t3(e4));
    }
  })), K);
  let r = V.get(e2);
  return r || (r = /* @__PURE__ */ new Set(), V.set(e2, r), o.observe(e2, Y)), r.add(t), () => {
    const r2 = V.get(e2);
    r2 && (r2.delete(t), 0 === r2.size && (V.delete(e2), 0 === V.size ? o.disconnect() : (o.disconnect(), V.forEach((e3, t2) => {
      o.observe(t2, Y);
    }))));
  };
}
const G = e.forwardRef(({ id: t, anchorSelect: l, content: c, render: s, className: a, classNameArrow: d, variant: p = "dark", portalRoot: v, place: m = "top", offset: f = 10, wrapper: h = "div", children: y2 = null, openOnClick: w2 = false, positionStrategy: b2 = "absolute", middlewares: S2, delayShow: g2 = 0, delayHide: A2 = 0, autoClose: E2, float: _2 = false, hidden: T2 = false, noArrow: k2 = false, clickable: O2 = false, openEvents: C2, closeEvents: R2, globalCloseEvents: N2, imperativeModeOnly: x2 = false, style: L2, position: B2, isOpen: z2, defaultIsOpen: $2 = false, disableStyleInjection: I2 = false, border: j2, opacity: D2, arrowColor: H2, arrowSize: M2, setIsOpen: P2, afterShow: W2, afterHide: q2, disableTooltip: V2, role: K2 = "tooltip" }, Y2) => {
  var G2, Z2, J, Q, U, ee, te, oe;
  const [re, ne] = reactExports.useState(null), [le, ce] = reactExports.useState({}), ie = reactExports.useRef(null), se = reactExports.useRef(I2), ue = reactExports.useCallback((e2) => {
    ne((t2) => ((null == e2 ? void 0 : e2.isSameNode(t2)) || (ie.current = t2), e2));
  }, []), ae = (e2) => {
    const t2 = null == e2 ? void 0 : e2.getAttributeNames().reduce((t3, o) => {
      var r;
      if (o.startsWith("data-tooltip-")) {
        t3[o.replace(/^data-tooltip-/, "")] = null !== (r = null == e2 ? void 0 : e2.getAttribute(o)) && void 0 !== r ? r : null;
      }
      return t3;
    }, {});
    return t2;
  ...
  reactExports.useEffect(() => {
    ...
    const e2 = (e3) => {
      const t2 = ae(e3);
      ce((e4) => {
        const o = Object.keys(t2), r = Object.keys(e4);
        return o.length === r.length && o.every((o2) => t2[o2] === e4[o2]) ? e4 : t2;
      });
    };
    e2(re);
    return X(re, e2);
  ...
  if (s) {
    ...
    _e = t2 ? e.createElement("div", { ref: Te, className: "react-tooltip-content-wrapper" }, t2) : null;
  } else null != pe && (_e = pe);
