...
import { a as defineLazyEventHandler, b as HTTPError, c as H3Core } from "./_libs/h3.mjs";
...
const _lazy_xN1fg7 = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_xN1fg7 };
  return ((_m, p) => {
