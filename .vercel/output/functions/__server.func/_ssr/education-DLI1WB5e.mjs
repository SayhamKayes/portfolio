...
import { X as Route, Y as deleteEducation, Z as restoreEducation, _ as permanentlyDeleteEducation, $ as editEducation, a0 as addEducation } from "./router-FAyYDvWX.mjs";
