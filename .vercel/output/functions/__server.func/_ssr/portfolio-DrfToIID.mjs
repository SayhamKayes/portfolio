...
import { z as Route$4, A as deletePortfolioItem, B as restorePortfolioItem, C as permanentlyDeletePortfolioItem, D as editPortfolioItem, E as addPortfolioItem } from "./router-FAyYDvWX.mjs";
