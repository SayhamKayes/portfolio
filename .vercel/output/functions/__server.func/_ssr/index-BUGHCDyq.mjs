...
import { b as Route$8 } from "./router-BWXE6ZyD.mjs";
import "../_libs/seroval.mjs";
import { B as Briefcase, C as Code, l as Users, u as MessageSquare, c as Globe, v as Settings } from "../_libs/lucide-react.mjs";
...
function AdminDashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-zinc-900 p-6 rounded-xl border border-gray-200 dark:border-zinc-800 mt-8", children: [
